...
jQuery(document).ready(function() {
	"use strict";
		...
		var _sw = '<!-- STYLESWITCHER - REMOVE ON PRODUCTION/DEVELOPMENT -->'
				...
				+ '		<center class="mar_cus"><h4><a href="http://astroduniya.com/query" class="btn btn-sm btn-warning btn-block" title="ask free query to astrologer"><span class="fs--15">Ask Free Query</span></a></h4></center><center class="mar_cus mb-3"><h4><a href="#" class="btn btn-sm btn-warning btn-block" data-toggle="modal" data-target="#exampleModalScrollable" title="book astrologer"><span class="fs--15">Book Astrologer&nbsp;&nbsp;<span class="badge badge-pill badge-light">paid</span></span></a></h4></center>'
				+ '			</hr>'
				
				+ '		<ul class="clearfix">'
				
				+ '			<li>&nbsp;<a href="https://wa.me/919699342442/?text=subscribe" target="_blank" aria-label="whatsapp page"> <img src="../../../images/social/whatsapp.png" width="30px" height="30px" alt="whatsapp">&nbsp;</a></li>'
				+ '			<li> <a href="#" target="_blank" aria-label="facebook page"> <img src="../../../images/social/facebook.png" width="30px" height="30px" alt="facebook">&nbsp;</a></li>'
				+ '			<li> <a href="#" target="_blank" aria-label="twitter page"> <img src="../../../images/social/twitter.png" width="30px" height="30px" alt="twitter">&nbsp;</a></li>'
				+ '			<li> <a href="#" target="_blank" aria-label="youtube page"> <img src="../../../images/social/youtube.png" width="30px" height="30px" alt="youtube">&nbsp;</a></li>'
				+ '			<li> <a href="#" target="_blank" aria-label="instagram page"> <img src="../../../images/social/instagram.png" width="30px" height="30px" alt="instagram"></a></li>'
				...
				+ '<div id="showSwitcher" class="styleSecondColor"><img src="../../../images/other/add.png" width="45px" height="45px"></div>'
				+ '<!-- /STYLESWITCHER -->';

	// ADD CLASS
	jQuery("head").append('<link href="../../../plugins/styleswitcher/styleswitcher.css" rel="stylesheet" type="text/css" />');
	...
	**/
	jQuery("input.dark_switch").bind("click", function() {
		...
		if(color_skin == 'dark') {
			...
			jQuery("a.logo img").attr('src', 'images/logo_light.png');
		} else {
			jQuery("#css_dark_skin").remove();
			createCookie("color_skin", '', -1);
			jQuery("a.logo img").attr('src', 'images/logo_dark.png');
		}
	});
	...
	**/
	jQuery("input.rtl_switch").bind("click", function() {
		...
		if(_direction == 'rtl') {
			...
			jQuery("head").append('<link href="plugins/bootstrap/RTL/bootstrap-rtl.min.css" rel="stylesheet" type="text/css" id="rtl_ltr_b1" />');
			jQuery("head").append('<link href="plugins/bootstrap/RTL/bootstrap-flipped.min.css" rel="stylesheet" type="text/css" id="rtl_ltr_b2" />');
	...
	function setActiveStyleSheet(title) {
		if(title != 'null' && title != null) {
			...
			if(jQuery("#css_dark_skin").length < 1) {
				// jQuery("a.logo img").attr('src', 'images/demo/logo/' + title + '.png');
			}
	...
	**/
	function resetSwitcher() {
		...
		jQuery('body').attr('data-background', '');
		jQuery('.backstretch').remove();
		jQuery("a.logo img").attr('src', 'images/logo.png');
