...
<?php if ( Request::segment(2)=='report' ? 'active' : '' ) : ?>
<div>
	<h3 class="h4 pt-3 pb-3 m-0 d-lg-block mb-2">
		Benefits
	</h3>

	<div class="d-flex mb-3">
		<div class="badge badge-secondary badge-ico-sm rounded-circle float-start">
			<i class="fi fi-check"></i>
		</div>

		<p class="text-dark font-weight-light mb-0 pl--10 pr--10 fs--15">
	...
	<div class="d-flex mb-3">
		...
		<p class="text-dark font-weight-light mb-0 pl--10 pr--10 fs--15">
			Take decisions based on report.
		</p>
	</div>
...
<div>
	<h4 class="items letter-spacing-1">Horoscope Zone<span class="widget-title"></span></h4>
	<ul class="list-unstyled">

		<li class="list-item border-bottom py-1">
			<a class="text-dark font-weight-light fs--15" href="{{ url('/horoscope/prediction/daily') }}"><span>Daily Horoscope</span></a>
		</li>

		<li class="list-item border-bottom py-1">
			<a class="text-dark font-weight-light fs--15" href="{{ url('/horoscope/prediction/weekly') }}"><span>Weekly Horoscope</span></a>
		</li>

		<li class="list-item border-bottom py-1">
			<a class="text-dark font-weight-light fs--15" href="{{ url('/horoscope/prediction/monthly') }}"><span>Monthly Horoscope</span></a>
		</li>

		<li class="list-item border-bottom py-1">
			<a class="text-dark font-weight-light fs--15" href="{{ url('/horoscope/prediction/yearly') }}"><span>Yearly Horoscope</span></a>	
		</li>
