...
@section('title','Meet Astrologer Personally - Astroduniya')
@section('description','Meet astrologer personally and get complete detailed clairvoyance of your query. Get best astrological solutions from our astrologer in personal meeting.')
@section('keywords','meet astrologer personally, meet astrologer, consultant astrologer, astrology consultation, astrology consultation online, online astrology service, astrology services online')
<!-- End of layout, title, description, keywords -->

<!-- toolbar page title -->
<?php 
	$toolbar_page="Meet Astrologer Personally"; 
	$toolbar_title="Meet Astrologer";
?>
<!-- /toolbar page title -->
