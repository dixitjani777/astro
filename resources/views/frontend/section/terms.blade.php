...
@section('title','Terms & Conditions - Astroduniya')
...
<!-- toolbar page title -->
<?php 
	$toolbar_page="Terms Conditions"; 
	$toolbar_title="Terms & Conditions";
?>
<!-- /toolbar page title -->
...
<section>
	<div class="container">
		...
		<h3 class="mb-4 my-4">Confidentiality</h3>
		...
		<h3 class="mb-4 my-4">Disclaimer</h3>
		<p class="fs--25">Exclusions and Limitations</p>
		...
		<h3 class="mb-4 my-4">Cancellation Policy</h3>
		...
		<h3 class="mb-4 my-4">Termination of Agreements and Refunds Policy</h3>
		...
		<h3 class="mb-4 my-4">Availability</h3>
		...
		<h3 class="mb-4 my-4">Log Files</h3>
		...
		<h3 class="mb-4 my-4">Links to this website </h3>
		...
		<h3 class="mb-4 my-4">Links from this website </h3>
		...
		<h3 class="mb-4 my-4">Copyright Notice </h3>
		...
		<h3 class="mb-4 my-4">Communication</h3>
		...
		<h3 class="mb-4 my-4">Force Majeure</h3>
		...
		<h3 class="mb-4 my-4">Notification of Changes</h3>
