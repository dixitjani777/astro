...
-->
<section class="swiper-container swiper-btn-group swiper-btn-group-end text-white mt-0 p-0 h-58vh" 
	data-swiper='{
		"slidesPerView": 1,
		"spaceBetween": 0,
	...
	<div class="swiper-wrapper h-100">
		...
		<!-- slide 2 -->
		<div class="lazy swiper-slide h-100 bg-white bg-cover" style="background-image:url('../images/slider/panditji.jpg')">
			<div class="container z-index-10 text-white slidintext">
