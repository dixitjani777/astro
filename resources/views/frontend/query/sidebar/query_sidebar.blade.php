<div>
	...
	<div class="d-flex mb-3">
		...
		<p class="text-dark font-weight-light mb-0 pl--10 pr--10 fs--15">
			Perfect astrological solutions.
		</p>
	</div>
...
<div id="sidebar_expand_mobile" class="d-none d-lg-block">
	...
	<ul class="list-unstyled">
		...
		<li class="list-item border-bottom py-1">
			<a class="text-dark font-weight-light fs--15" href="{{ url('/horoscope/minihreport') }}">Horoscope Report</a>
		</li>
		...
		<li class="list-item border-bottom py-1">
			<a class="text-dark font-weight-light fs--15" href="{{ url('/astrologer/callbooking') }}">Book Astrologer</a>
		</li>
	...
	<div id="clipboard_2" class="mb-3">
		...
		<div class="embed-responsive embed-responsive-16by9">
			<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/zGRl4qDfH3o"></iframe>
		</div>
