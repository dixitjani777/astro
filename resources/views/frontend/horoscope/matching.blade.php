...
<!-- toolbar page title -->
<?php 
	$toolbar_page="Horoscope Matching Report"; 
	$toolbar_title="Matchmaking";
?>
<!-- /toolbar page title -->
		...
		<div class="row">	
			<div class="col-lg-9 order-1 order-lg-1">		
				<div>
					...
					<p>
						Horoscope report consists personality of couples. It give you various information of couples in detailed like nature, interests, temperaments of the couple and much more.<span class="font-weight-medium"> Order compatibility report and get information of couples in detailed.</span>
					</p> 
						...
						<form novalidate method="post" action="#" class="bs-validate d-block bg-white shadow-md rounded p-4 mb-5 ">
							...
							<div class="clearfix mb-3">
								<div class="form-label-group">
									...
									<label for="comment_description">Add additional details If any</label>
								</div>
