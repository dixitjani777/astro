...
@section('title','Monthly Horoscope : Predictions for All Zodiac - Astroduniya')
@section('description','Read monthly horoscope for aries, taurus, gemini, cancer, leo, virgo, libra, scorpio, sagittarius, capricorn, aquarius, pisces')
@section('keywords','monthly horoscope, aries horoscope, taurus horoscope, gemini horoscope, cancer horoscope, leo horoscope, virgo horoscope, libra horoscope, scorpio horoscope, sagittarius horoscope, capricorn horoscope, aquarius horoscope, pisces horoscope')
			...
			<div class="col-md-9 col-sm-9">
					...
					<div class="col-12 col-md-6">
						<div class="form-label-group mb-3">
							<select id="horoscopePeriodSelect" class="form-control">
								...
								<option value="monthly" selected>Monthly Horoscope</option>
				...
				<script>
					(function () {
						...
						function go() {
							var period = (periodSel.value || 'monthly').toLowerCase();
