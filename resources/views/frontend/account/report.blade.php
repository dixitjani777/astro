		...
		<div class="row">
			...
			<div class="col-12 col-sm-12 col-md-12 col-lg-3 mb--60">
				...
				<ul class="nav nav-tabs">
					<li class="nav-item">
						<a class="nav-link nav-link-remember font-weight-medium active" data-toggle="tab" href="#tab_account">Horoscope</a>
					</li>

					<li class="nav-item">
						<a class="nav-link nav-link-remember font-weight-medium" data-toggle="tab" href="#tab_address">Matchmaking</a>
					</li>
				</ul>
