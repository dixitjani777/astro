		...
		<div class="row">
			...
			<div class="col-12 col-sm-12 col-md-12 col-lg-9">
				...
				<ul class="nav nav-tabs">
					<li class="nav-item">
						<a class="nav-link nav-link-remember active" data-toggle="tab" href="#tab_account">Vastu</a>
					</li>

					<li class="nav-item">
						<a class="nav-link nav-link-remember" data-toggle="tab" href="#tab_address">Specific</a>
					</li>
				</ul>
