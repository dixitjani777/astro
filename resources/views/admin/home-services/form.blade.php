...
@section('title', $service->exists ? 'Edit Home Service' : 'New Home Service')

@section('content')
    <div class="page-header d-print-none">
        <div class="row align-items-center">
            <div class="col">
                <h2 class="page-title">{{ $service->exists ? 'Edit Home Service' : 'New Home Service' }}</h2>
            </div>
            <div class="col-auto ms-auto d-print-none">
                <a href="{{ route('admin.home-services.index') }}" class="btn btn-outline-secondary">Back</a>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form method="post" action="{{ $service->exists ? route('admin.home-services.update', $service) : route('admin.home-services.store') }}">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="link_url" value="{{ old('link_url', $service->link_url) }}" placeholder="/query">
                    </div>
                </div>
